...
### 🎙️ [Spoken Language Identification](https://github.com/biniyam112/spoken_language_identification)
`Python` `PyTorch` `CNNs` `LSTMs`
Residual CNN classifying **9 languages** from log-Mel spectrograms — **89.3% test accuracy** on 114K+ audio clips, outperforming a bidirectional LSTM baseline (80.5%). Analyzed via confusion matrices and PCA of learned embeddings.

### 🚕 [NYC TLC Ride-Sharing Analysis](https://github.com/biniyam112/NYC-FHV-Data-Mining)
`Python` `Random Forest` `Unsupervised Learning`
Predicted ride-sharing match outcomes across NYC for-hire vehicle trips, showing incentivized pooling could cut **peak-hour traffic by up to 30%**.

### 🗣️ [What Makes US Angry?](https://github.com/biniyam112/hophacks-tweet-sentiment)
`Python` `NLP` `marimo`
**4.8M congressional tweets** scored for anger and shipped as an interactive web story (HopHacks 2026).
...
**ML & Data:** PyTorch · Scikit-learn · Pandas · LangChain · BeautifulSoup
**Methods:** Deep Learning (CNNs, LSTMs) · RAG & Embeddings · Classification & Clustering · Model Optimization · EDA
**Data & Infra:** PostgreSQL · Snowflake · Elasticsearch · Supabase · Docker · AWS · GCP
**Viz & App:** Tableau · Flutter · REST APIs · Git
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/biniyam-demissew/)
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=flat&logo=leetcode&logoColor=white)](https://leetcode.com/biniyam112)
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:biniyamd.zergaw@gmail.com)
